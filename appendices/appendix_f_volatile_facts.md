...
> Last verified: 2026-05-18. 本表用于约束本书中模型、工具、价格、上下文窗口、benchmark 和规则性事实的更新。
...
| Google Gemini | Gemini 3.x、Deep Think、音视频能力以 Google AI 文档为准。 | [Gemini Models](https://ai.google.dev/gemini-api/docs/models) | 不使用“Gemini Ultra”等非官方名称。 |
