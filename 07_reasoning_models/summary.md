...
| Adaptive Thinking | Fable 5 / Mythos 5（常开；2026-06-12 起访问暂停）、Opus 4.8、Opus 4.7、Opus 4.6 和 Sonnet 4.6 支持的推理模式，模型会根据问题难度自动调节思考深度 |
| 知识蒸馏 | 将大模型的能力压缩到小模型中 |
