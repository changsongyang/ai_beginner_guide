...
这就是”推理模型”（Reasoning Models）的核心理念。OpenAI 从 o 系列进一步演进到 GPT-5.4，Anthropic 的 Claude Extended Thinking、DeepSeek 的 R1 等一系列能力路线的出现，标志着 AI 已经进入了一个新的阶段。

## 本章内容

- **7.1 两种思维方式：System 1 vs System 2**：理解为什么有时候快速反应，有时候需要深入思考
- **7.2 推理模型的工作原理**：解析 OpenAI o 系列到 GPT-5.4、Claude Extended Thinking 等模型如何进行”思考”
- **7.3 推理计算（Inference-Time Compute）**：掌握新的计算范式
- **7.4 各主流推理模型对比**：深度求索 R1、OpenAI 最新推理路线、Claude Extended Thinking 的核心差异
